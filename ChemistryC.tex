...
\tableofcontents
\mainmatter
\input{contents/3-1.tex} % ok
\input{contents/3-2.tex} % ok
\input{contents/3-3.tex} % ok
\input{contents/3-4.tex} % ok
\input{contents/3-5.tex} % ok
\input{contents/app3-1.tex} % ok
\appendix
\input{contents/app3-2.tex} % ok
\end{document}