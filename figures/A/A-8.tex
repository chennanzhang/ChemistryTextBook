...
\newcommand{\WatchGlass}[3][]{
  \begin{scope}[#1]
    \fill[#3,fill opacity=0.3](#2:0.5)arc(#2:-#2-180:0.5)--cycle;
    \draw[fill=cyan!10!white,fill opacity=0.2](-25:0.5)arc(-25:-155:0.5)--cycle;
...
\begin{tikzpicture}[>=stealth,scale=1.6,inner sep=2pt]
  ...
  \WatchGlass[xshift=1.2cm,yshift=2.38cm]{-40}{cyan!40!white};
