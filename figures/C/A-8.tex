...
\begin{tikzpicture}[>=stealth,scale=1.2,inner sep=2pt]
  ...
  \thermometer[yshift=2.2cm]{1.2}{1.7}
  \AlcoholBurner
  \FlameThick[yshift=7.2mm]{0}
  \VTube[yshift=1.6cm]{1.5}{0.3}
  \beaker[yshift=1.12cm]{0.8}{1.2}{0.8}{cyan!30!white,fill opacity=0.3}
  ...
  \draw[very thin](-0.15,3.1)--++(-0.65,0);
  \fill[darkgray,even odd rule](-0.8,3.1)circle(0.15)(-0.8,3.1)circle(0.6pt)(-0.8,2.96)circle(0.01);
\end{tikzpicture}
\end{document}