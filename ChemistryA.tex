...
\tableofcontents
\mainmatter
\input{contents/1-1.tex} % ok
\input{contents/1-2.tex} % ok
\input{contents/1-3.tex} % ok
\input{contents/1-4.tex} % ok
\input{contents/1-5.tex} % ok 
\input{contents/app1-1.tex} % ok
\appendix
